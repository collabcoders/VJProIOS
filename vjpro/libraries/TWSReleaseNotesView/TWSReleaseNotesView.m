...
- (id)initWithReleaseNotesTitle:(NSString *)releaseNotesTitle text:(NSString *)releaseNotesText closeButtonTitle:(NSString *)closeButtonTitle
{
    ...
    if (self)
    {
        ...
        _titleFont = [UIFont boldSystemFontOfSize:23.0f];
        _titleColor = [UIColor colorWithRed:255/255.0f green:1/255.0f blue:0/255.0f alpha:1.0f]; //[UIColor whiteColor];
        ...
        _closeButtonFont = [UIFont systemFontOfSize:19.0f];
...
- (CGFloat)expectedReleaseNotesTextHeightWithWidth:(CGFloat)width;
{
    ...
    CGSize expectedLabelSize = maximumLabelSize;
